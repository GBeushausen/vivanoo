const AdminFixtureService = require('@shopware-ag/e2e-testsuite-platform/cypress/support/service/administration/fixture.service.js');

class WwCustomerFixtureService extends AdminFixtureService {
	setWwCustomerFixture(customerJson, customerAddressJson) {
		...
		return Promise.all([
			...
			.then((finalCustomerData) => {
				return this.apiClient.post('/customer?_response=true', finalCustomerData);
			});
	}
}

module.exports = WwCustomerFixtureService;
global.WwCustomerFixtureService = new WwCustomerFixtureService();